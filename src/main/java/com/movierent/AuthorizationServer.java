...
public class AuthorizationServer extends AuthorizationServerConfigurerAdapter {
	...
	//Create the token and hash the password with bcrypt 
	//defining as access token
	//defining token expiration time
	//defining token refresh
	@Override
	public void configure(ClientDetailsServiceConfigurer configurer) throws Exception {
		...
		.scopes(scopeRead, scopeWrite).resourceIds(resourceIds).accessTokenValiditySeconds(240)
		.refreshTokenValiditySeconds(0);
	}

	
	//Generate string jwt text
	@Override
